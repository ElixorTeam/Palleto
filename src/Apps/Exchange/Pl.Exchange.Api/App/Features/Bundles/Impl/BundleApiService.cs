...
internal sealed partial class BundleApiService(BundleDtoValidator validator, ILogger<BundleApiService> logger,  WsDbContext dbContext)
    : BaseService<BundleDto>(validator), IBundleService
{
