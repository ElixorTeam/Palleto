...
public class ButtonTests : TestContext
{
    ...
    public void DefaultParameters_RenderCorrectly()
    {
        ...
        buttonElement.MarkupMatches(
            """
            <button class="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-5 bg-primary text-primary-foreground hover:bg-primary/90 h-9 px-4 py-2" type="button"></button>
            """);
    }
