...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pl.Database.Entities.Print.LabelsZpl.LabelZplEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("UID");
            ...
            modelBuilder.Entity("Pl.Database.Views.Diag.DatabaseTables.DatabaseTableView", b =>
                {
            ...
            modelBuilder.Entity("Pl.Database.Entities.Print.Labels.LabelEntity", b =>
                {
                    ...
                    b.HasOne("Pl.Database.Entities.Print.Pallets.PalletEntity", "Pallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Pl.Database.Entities.Print.LabelsZpl.LabelZplEntity", b =>
                {
                    b.HasOne("Pl.Database.Entities.Print.Labels.LabelEntity", null)
                        .WithOne("Zpl")
                        .HasForeignKey("Pl.Database.Entities.Print.LabelsZpl.LabelZplEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Pl.Database.Entities.Ref1C.Plus.PluEntity", b =>
                {
                    ...
                    b.HasOne("Pl.Database.Entities.Zpl.Templates.TemplateEntity", "Template")
                        .WithMany()
